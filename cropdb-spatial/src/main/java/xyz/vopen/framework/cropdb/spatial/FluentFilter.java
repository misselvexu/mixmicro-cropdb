...
public class FluentFilter {
  ...
  /**
   * Creates an spatial filter which matches documents where the spatial data of a field intersects
   * the specified {@link Geometry} value.
   *
  ...
  /**
   * Creates a spatial filter which matches documents where the spatial data of a field is within
   * the specified {@link Geometry} value.
   *
   * @param geometry the geometry
   * @return the filter
  ...
  /**
   * Creates a spatial filter which matches documents where the spatial data of a field is near the
