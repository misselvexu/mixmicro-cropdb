...
public interface CollectionInstruction extends Instruction {
  ...
  /**
   * Adds an instruction to add new field to the documents of a {@link CropCollection}.
   *
  ...
  /**
   * Adds an instruction to add new field with a default value, into the documents of a {@link
   * CropCollection}.
   *
   * @param fieldName the field name
  ...
  /**
   * Adds an instruction to add new field with value generator, into the document of a {@link
   * CropCollection}.
   *
   * @param fieldName the field name
  ...
  /**
   * Adds an instruction to rename a field to the document of a {@link CropCollection}.
   *
  ...
  /**
   * Adds an instruction to delete a field from the document of a {@link CropCollection}.
   *
   * @param fieldName the field name
   * @return the collection instruction
   */
