...
public abstract class Migration {
  ...
  @Getter private final Integer startVersion;

  @Getter private final Integer endVersion;
  ...
  private void execute() {
    DefaultInstructions instruction = new DefaultInstructions(migrationSteps);
    migrate(instruction);
    this.executed = true;
  }
}
