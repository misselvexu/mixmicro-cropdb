...
import static xyz.vopen.framework.cropdb.common.Constants.KEY_OBJ_SEPARATOR;
import static xyz.vopen.framework.cropdb.common.util.Iterables.toArray;
...
public class ObjectUtils {
  ...
  public static boolean deepEquals(Object o1, Object o2) {
    ...
    if (o1 instanceof Number && o2 instanceof Number) {
      ...
      Map map1 = (Map) o1;
      Map map2 = (Map) o2;
      return deepEquals(Iterables.toArray(map1.entrySet()), Iterables.toArray(map2.entrySet()));
    } else {
      // generic check
      return o1.equals(o2);
    }
  ...
  public static <T extends Serializable> T deepCopy(T oldObj) {
    ...
    try (ObjectOutputStream oos = new ObjectOutputStream(bos)) {
      ...
      throw new CropIOException("error while deep copying object", e);
    }
  }
