...
import xyz.vopen.framework.cropdb.exceptions.MigrationException;
import xyz.vopen.framework.cropdb.exceptions.CropIOException;
import xyz.vopen.framework.cropdb.migration.commands.*;
...
import static xyz.vopen.framework.cropdb.common.Constants.STORE_INFO;
...
public class MigrationManager {
   ...
   */
  public MigrationManager(CropDB cropdb) {
    this.database = cropdb;
    this.cropConfig = cropdb.getConfig();
    this.storeMetadata = cropdb.getDatabaseMetaData();
  }
  ...
  public void doMigrate() {
    if (isMigrationNeeded()) {
      ...
      Integer incomingVersion = cropConfig.getSchemaVersion();
      ...
      if (migrationPath == null || migrationPath.isEmpty()) {
        ...
        throw new MigrationException(
            "schema version mismatch, as no migration path found from version "
                + storeMetadata.getSchemaVersion()
                + " to "
                + cropConfig.getSchemaVersion());
      }
  ...
  private Queue<Migration> findUpMigrationPath(boolean upgrade, int start, int end) {
    ...
    while (upgrade ? start < end : start > end) {
      TreeMap<Integer, Migration> targetNodes = cropConfig.getMigrations().get(start);
      if (targetNodes == null) {
        return null;
      }
  ...
  private void executeMigrationSteps(Queue<MigrationStep> migrationSteps) {
    ...
    metaData.setSchemaVersion(cropConfig.getSchemaVersion());

    CropMap<String, Document> storeInfo =
        database.getStore().openMap(STORE_INFO, String.class, Document.class);
  ...
  private void executeStep(MigrationStep step) {
    if (step != null) {
      ...
      switch (step.getInstructionType()) {
        case AddPassword:
          Pair<String, SecureString> arg1 = (Pair<String, SecureString>) step.getArguments();
          command =
              crop -> {
                UserAuthenticationService authService =
                    new UserAuthenticationService(crop.getStore());
                authService.addOrUpdatePassword(false, arg1.getFirst(), null, arg1.getSecond());
              };
          break;
        ...
        case ChangePassword:
          ...
          command =
              crop -> {
                UserAuthenticationService authService =
                    new UserAuthenticationService(crop.getStore());
                authService.addOrUpdatePassword(
        ...
        case CollectionAddField:
          Triplet<String, String, Object> arg6 =
              (Triplet<String, String, Object>) step.getArguments();
          command = new AddField(arg6.getFirst(), arg6.getSecond(), arg6.getThird());
          break;

        case CollectionRenameField:
          Triplet<String, String, String> arg7 =
              (Triplet<String, String, String>) step.getArguments();
        ...
        case CollectionCreateIndex:
          Triplet<String, Fields, String> arg10 =
              (Triplet<String, Fields, String>) step.getArguments();
          command = new CreateIndex(arg10.getFirst(), arg10.getSecond(), arg10.getThird());
          break;

        case RenameRepository:
          Quartet<String, String, String, String> arg11 =
        ...
        case RepositoryAddField:
          ...
          command =
              new AddField(
                  findRepositoryName(arg13.getFirst(), arg13.getSecond()),
                  arg13.getThird(),
                  arg13.getFourth());
          break;
        ...
        case RepositoryRenameField:
          ...
          command =
              new RenameField(
                  findRepositoryName(arg14.getFirst(), arg14.getSecond()),
                  arg14.getThird(),
                  arg14.getFourth());
          break;

        case RepositoryDeleteField:
          Triplet<String, String, String> arg15 =
              (Triplet<String, String, String>) step.getArguments();
          command =
              new DeleteField(
                  findRepositoryName(arg15.getFirst(), arg15.getSecond()), arg15.getThird());
          break;
        ...
        case RepositoryChangeDataType:
          ...
          command =
              new ChangeDataType(
                  findRepositoryName(arg16.getFirst(), arg16.getSecond()),
                  arg16.getThird(),
                  arg16.getFourth());
          break;
        ...
        case RepositoryChangeIdField:
          ...
          command =
              new ChangeIdField(
                  findRepositoryName(arg17.getFirst(), arg17.getSecond()),
                  arg17.getThird(),
                  arg17.getFourth());
          break;

        case RepositoryDropIndex:
          Triplet<String, String, Fields> arg18 =
              (Triplet<String, String, Fields>) step.getArguments();
          command =
              new DropIndex(
                  findRepositoryName(arg18.getFirst(), arg18.getSecond()), arg18.getThird());
          break;
