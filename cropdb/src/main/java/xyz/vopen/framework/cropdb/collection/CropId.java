...
/**
 * An unique identifier across the Crop database. Each document in
 * a crop collection is associated with a {@link CropId}.
 * <p>
 ...
 * create a new {@link CropId}. If that is not supplied, then crop
