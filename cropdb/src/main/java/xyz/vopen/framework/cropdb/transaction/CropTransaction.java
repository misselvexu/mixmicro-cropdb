...
class CropTransaction implements Transaction {
    ...
    public synchronized CropCollection getCollection(String name) {
        ...
        CropMap<CropId, Document> txMap = transactionStore.openMap(name,
            CropId.class, Document.class);
    ...
    public synchronized <T> ObjectRepository<T> getRepository(Class<T> type) {
        ...
        CropCollection backingCollection = new DefaultTransactionalCollection(primaryCollection, context, cropdb);
