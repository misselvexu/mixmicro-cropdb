...
public class Constants {
    ...
    static {
        ...
        try (InputStream is = ClassLoader.getSystemClassLoader().getResourceAsStream("version")) {
            ...
            throw new CropIOException("failed to load version information", e);
        }
        CROPDB_VERSION = v;
    }

    /**
     * The constant CROPDB_VERSION.
     */
    public static final String CROPDB_VERSION;

    /**
     * The constant INDEX_META_PREFIX.
     */
    public static final String INDEX_META_PREFIX = "$crop_index_meta";

    /**
     * The constant INDEX_PREFIX.
     */
    public static final String INDEX_PREFIX = "$crop_index";
     ...
     */
    public static final String USER_MAP = "$crop_users";
     ...
     */
    public static final String META_MAP_NAME = "$crop_meta_map";

    /**
     * The constant STORE_INFO.
     */
    public static final String STORE_INFO = "$crop_store_info";

    /**
     * The constant COLLECTION_CATALOG.
     */
    public static final String COLLECTION_CATALOG = "$crop_catalog";
    ...
    /**
     * The constant ID_PREFIX used in {@link CropId#toString()}.
     */
    ...
    /**
     * The constant ID_SUFFIX used in {@link CropId#toString()}.
     */
