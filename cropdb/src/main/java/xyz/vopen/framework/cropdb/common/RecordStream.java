        ...
        () ->
            new Iterator<T>() {
              private final Iterator<T> firstIterator =
                  first != null ? first.iterator() : Collections.emptyIterator();
              private final Iterator<T> secondIterator =
                  second != null ? second.iterator() : Collections.emptyIterator();
        ...
        () ->
            new Iterator<T>() {
              private final Iterator<T> iterator =
                  iterable != null ? iterable.iterator() : Collections.emptyIterator();
              private T nextItem;
