...
public final class FluentFilter {
  ...
  /**
   * Creates an equality filter which matches documents where the value of a field equals the
   * specified value.
   *
   * @param value the value
   * @return the equality filter.
   */
  public CropFilter eq(Object value) {
    return new EqualsFilter(field, value);
  }

  /**
   * Creates an equality filter which matches documents where the value of a field not equals the
   * specified value.
   *
   * @param value the value
   * @return the filter
   */
  public CropFilter notEq(Object value) {
    return new NotEqualsFilter(field, value);
  }

  /**
   * Creates a greater than filter which matches those documents where the value of the field is
   * greater than (i.e. &gt;) the specified value.
   *
   * @param value the value
   * @return the greater than filter
   */
  public CropFilter gt(Comparable<?> value) {
    return new GreaterThanFilter(field, value);
  }

  /**
   * Creates a greater equal filter which matches those documents where the value of the field is
   * greater than or equals to (i.e. &ge;) the specified value.
   *
   * @param value the value
   * @return the greater or equal filter
   */
  public CropFilter gte(Comparable<?> value) {
    return new GreaterEqualFilter(field, value);
  }

  /**
   * Creates a lesser than filter which matches those documents where the value of the field is less
   * than (i.e. &lt;) the specified value.
   *
   * @param value the value
   * @return the lesser than filter
   */
  public CropFilter lt(Comparable<?> value) {
    return new LesserThanFilter(field, value);
  }

  /**
   * Creates a lesser equal filter which matches those documents where the value of the field is
   * lesser than or equals to (i.e. &le;) the specified value.
   *
   * @param value the value
   * @return the lesser equal filter
   */
  public CropFilter lte(Comparable<?> value) {
    return new LesserEqualFilter(field, value);
  }

  /**
   * Creates a between filter which matches those documents where the value of the field is within
   * the specified bound including the end values.
   *
   * <pre>{@code
   ...
   */
  public CropFilter between(Comparable<?> lowerBound, Comparable<?> upperBound) {
   ...
   * @return the between filter
   */
  public CropFilter between(Comparable<?> lowerBound, Comparable<?> upperBound, boolean inclusive) {
   ...
   * @return the between filter
   */
  public CropFilter between(
      Comparable<?> lowerBound,
      Comparable<?> upperBound,
      boolean lowerInclusive,
      boolean upperInclusive) {
    return new BetweenFilter<>(
        field, new BetweenFilter.Bound<>(lowerBound, upperBound, lowerInclusive, upperInclusive));
  }

  /**
   * Creates a text filter which performs a text search on the content of the fields indexed with a
   * full-text index.
   *
   ...
   * @see TextTokenizer
   */
  public CropFilter text(String value) {
    return new TextFilter(field, value);
  }

  /**
   * Creates a string filter which provides regular expression capabilities for pattern matching
   * strings in documents.
   *
   * @param value the regular expression
   * @return the regex filter
   */
  public CropFilter regex(String value) {
    return new RegexFilter(field, value);
  }

  /**
   * Creates an in filter which matches the documents where the value of a field equals any value in
   * the specified array.
   *
   * @param values the range values
   * @return the in filter
   */
  public CropFilter in(Comparable<?>... values) {
    return new InFilter(field, values);
  }

  /**
   * Creates a notIn filter which matches the documents where the value of a field not equals any
   * value in the specified array.
   *
   * @param values the range values
   * @return the notIn filter
   */
  public CropFilter notIn(Comparable<?>... values) {
    return new NotInFilter(field, values);
  }

  /**
   * Creates an element match filter that matches documents that contain an array value with at
   * least one element that matches the specified filter.
   *
   * @param filter the filter to satisfy
   * @return the element match filter
   */
  public CropFilter elemMatch(Filter filter) {
