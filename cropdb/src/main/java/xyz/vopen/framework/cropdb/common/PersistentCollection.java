...
public interface PersistentCollection<T> extends EventAware, MetadataAware, AutoCloseable {
     ...
     * then crop will generate a new {@link CropId} and will add it to the <b>_id</b>
     * field.
     * <p>
     ...
     * @throws InvalidIdException        if the <b>_id</b> field's value contains non comparable type, i.e. type that does not implement {@link Comparable}.
     * @throws InvalidIdException        if the <b>_id</b> field contains value which is not of the same java type as of other element's <b>_id</b> field value in the collection.
     * @throws UniqueConstraintException if the value of <b>_id</b> field clashes with the <b>_id</b> field of another element in the repository.
