...
public interface RepositoryInstruction extends Instruction {
  ...
  /**
   * Adds an instruction to add new field to the entity in the {@link ObjectRepository}.
   *
  ...
  /**
   * Adds an instruction to add new field with a default value, into the entity in the {@link
   * ObjectRepository}.
   *
   * @param <T> the type parameter
   * @param fieldName the field name
  ...
  /**
   * Adds an instruction to add new field with value generator, into the entity in the {@link
   * ObjectRepository}.
   *
   * @param <T> the type parameter
   * @param fieldName the field name
  ...
  /**
   * Adds an instruction to rename a field to the entity in the {@link ObjectRepository}.
   *
  ...
  /**
   * Adds an instruction to delete a field from the entity in the {@link ObjectRepository}.
   *
   * @param fieldName the field name
   * @return the repository instruction
   */
  ...
  /**
   * Adds an instruction to change the datatype of a field of the entity in the {@link
   * ObjectRepository}.
   *
   * @param fieldName the field name
  ...
  /**
   * Adds an instruction to change the id field of an entity in the {@link ObjectRepository}
   *
   * @param oldFieldNames the old field names
   * @param newFieldNames the new field names
   * @return the repository instruction
   */
  default RepositoryInstruction changeIdField(
      List<String> oldFieldNames, List<String> newFieldNames) {
