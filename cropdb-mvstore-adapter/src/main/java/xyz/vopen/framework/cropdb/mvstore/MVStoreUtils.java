...
class MVStoreUtils {
      ...
      if (dbFile != null) {
        try {
          if (dbFile.isDirectory()) {
            throw new CropIOException(storeConfig.filePath() + " is a directory, must be a file");
          }
  ...
  private static MVStore tryMigrate(
      File orgFile, MVStore.Builder builder, MVStoreConfig storeConfig) {
