...
package xyz.vopen.framework.cropdb.kotlinx.filters

import xyz.vopen.framework.cropdb.filters.Filter
import xyz.vopen.framework.cropdb.filters.Filter.and
import xyz.vopen.framework.cropdb.filters.Filter.or
...
inline infix fun <reified T : Geometry> String.within(value: T?): Filter =
    xyz.vopen.framework.cropdb.spatial.FluentFilter.where(this).within(value)
...
inline infix fun <reified T : Geometry> String.intersects(value: T?): Filter =
    xyz.vopen.framework.cropdb.spatial.FluentFilter.where(this).intersects(value)
...
inline fun <reified T : Coordinate> String.near(value: T?, distance: Double): Filter =
    xyz.vopen.framework.cropdb.spatial.FluentFilter.where(this).near(value, distance)
...
inline infix fun <reified T : Geometry> KProperty<T?>.within(value: T?): Filter =
    xyz.vopen.framework.cropdb.spatial.FluentFilter.where(this.name).within(value)
...
inline infix fun <reified T : Geometry> KProperty<T?>.intersects(value: T?): Filter =
    xyz.vopen.framework.cropdb.spatial.FluentFilter.where(this.name).intersects(value)
...
inline fun <reified T : Geometry> KProperty<T?>.near(value: Point, distance: Double): Filter =
    xyz.vopen.framework.cropdb.spatial.FluentFilter.where(this.name).near(value, distance)
